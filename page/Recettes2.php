...
<head>
    ...
    <title>Recette - <?= htmlspecialchars($reponse) ?></title>
...
<body>
    ...
    <main class="main-content">
        <div class="page-header">
            <h1 class="page-title"><i class="fas fa-money-bill-wave"></i> Détail des Recettes</h1>
            <div class="title-underline"></div>
            <p class="page-subtitle">Vue détaillée des recettes budgétaires par catégorie</p>
        </div>
