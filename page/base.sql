...
('Hotel, restaurant', 14.7, 16.9, 'Sous-secteur', 'Tertiaire'),
...
('Impot sur les revenus', 1179.0, 1411.4, 'Categorie principale'),
('Impot sur les revenus Salariaux et Assimiles', 848.2, 869.9, 'Sous-categorie'),
('Impot sur les revenus des Capitaux Mobiliers', 78.2, 99.7, 'Sous-categorie'),
('Impot sur les plus-values Immobilières', 14.0, 18.3, 'Sous-categorie'),
('Impot Synthetique', 132.3, 164.7, 'Sous-categorie'),
...
('Impot sur les marches Publics', 148.7, 250.0, 'Categorie principale'),
