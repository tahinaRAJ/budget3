...
<head>
    ...
    <title>Ventilation - <?= htmlspecialchars($reponse) ?></title>
...
<body>
    ...
    <main class="main-content">
        <div class="page-header">
            <h1 class="page-title"><i class="fas fa-chart-pie"></i> Ventilation des Dépenses</h1>
            <div class="title-underline"></div>
            <p class="page-subtitle">Répartition détaillée des dépenses budgétaires</p>
        </div>
