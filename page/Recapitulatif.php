...
<head>
    ...
    <title>Récapitulatif - <?= htmlspecialchars($reponse) ?></title>
...
<body>
    ...
    <main class="main-content">
        <div class="page-header">
            <h1 class="page-title"><i class="fas fa-file-alt"></i> Récapitulatif Détailé</h1>
            <div class="title-underline"></div>
            <p class="page-subtitle">Vue complète des données de la table sélectionnée</p>
        </div>
